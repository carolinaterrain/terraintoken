        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="mb-16">
            <GlassCard className="p-8 md:p-12 bg-gradient-to-br from-primary/20 to-primary/5 hover:border-primary/40 transition-all">
              ...
              <div className="flex gap-4">
                ...
                <Button size="lg" variant="outline" className="font-display border-primary">
                  Read Full Article
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {blogPosts.slice(1).map((post) => (
              <GlassCard key={post.id} hover className="p-6 cursor-pointer">
