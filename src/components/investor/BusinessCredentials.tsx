...
export const BusinessCredentials = () => {
  const credentials = [
    {
      ...
      description: "Fully bonded & insured",
    ...
    },
    {
      ...
      value: "Since 2022",
      description: "Operating drainage and terrain services across NC",
      link: "/transparency",
      linkText: "View Transparency Hub",
      color: "text-chart-4",
    },
    {
      icon: Users,
      title: "Doxxed Founder",
      value: "100% Verified",
      description: "Public identity, NC-based",
      link: "/team",
  ...
  const differentiators = [
    "Tied to a licensed NC drainage contractor — not just a whitepaper",
